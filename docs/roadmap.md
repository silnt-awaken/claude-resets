...
Mirrors `/goal#roadmap` on the site; the source of truth is `src/goal/roadmap.ts`. Statuses are honest: **Live** is on the site today, **Switching on** is built and being configured, **Next** is planned, **Later** is direction rather than commitment. Nothing here promises a price.

## The tracker · September 2026 · Live
...
## Goal and token infrastructure · September 2026 · Switching on
...
## Long term · 2027 and beyond · Later
